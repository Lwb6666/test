...
<title>我要融资-诚薪贷借款信息填写_顶玺金融</title>
</head>
...
<div id="Bmain">
	...
	<div id="rz_main" style="height: 680px;">
		...
		<div class="rz_borrow">
			...
			<input id="isMortgage" name="isMortgage" type="radio" value="1" checked="checked" onclick="displaySet('mortgageDiv|mortgageTypeDiv','block');"/>有抵押&nbsp;&nbsp; 
			<input name="isMortgage" type="radio" value="0" onclick="displaySet('mortgageDiv|mortgageTypeDiv','none');"/>无抵押
		...
		<div class="rz_borrow1">
			<div class="rz_type1" style="border: none">
				...
				<div class="rz_borrow" style="margin: 40px 0">
					<div class="rz_btn">
						<a id="salariaBtn" href="javascript:salariatFormSubmit();">申请并继续</a>
					</div>
				</div>
...
function salariatFormSubmit(){
	document.getElementById('salariaBtn').href = 'javascript:void(0);';
	//验证
	attrSet('mostAccount-min-'+$("#lowestAccount").val()+'|mostAccount-max-'+$("#account").val()+'|lowestAccount-max-'+$("#account").val());
	if (Validator.Validate('salariatForm',1)==false) {
		document.getElementById('salariaBtn').href = 'javascript:salariatFormSubmit();';
		return;
	}
	...
	layer.confirm("确定提交吗？",function(){
		...
		$("#salariatForm").ajaxSubmit({
			url : '${basePath}/salariatBorrow/applySalariatBorrow.html',
			type : 'post',
			dataType :"json",
