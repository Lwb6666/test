				...
				<div class="sfmain">
					 ...
					 <form  id="myfrom1"   name="myfrom1"  method="post" >
						 ...
						 <tr>
						 	...
						 	<td > <input  class="rz_input mr5" type="file" name="files" id="files1" dataType="Require" msg="请选择要上传的文件" maxlength="180"/>
						    <input  type="hidden"  name="picType"   value="手持本人身份证明证件照片" >
						  <input class="rz_searchbtn" type="button" name="upbtn" id="upbtn1" onclick="forupload('myfrom1')" value="上传" /></td>
						  </tr>
						  </table>
					</form>
			     </tr>
               ...
               <tr>			
                     <form  id="myfrom2"   name="myfrom2" method="post" >
						 ...
						 <tr>
						 	...
						 	<td > <input  class="rz_input mr5" type="file" name="files" id="files2" dataType="Require" msg="请选择要上传的文件" maxlength="180"/>
						    <input  type="hidden"  name="picType"   value="银行卡挂失证明" >
						  <input  class="rz_searchbtn" type="button" name="upbtn" id="upbtn2" onclick="forupload('myfrom2')" value="上传" /></td>
						  </tr>
						  </table>
					</form>
					</tr>
                      ...
                      <form  id="myfrom3"   name="myfrom3" method="post" >
						 ...
						 <tr>
						 	...
						 	<td > <input class="rz_input mr5" type="file" name="files" id="files3" dataType="Require" msg="请选择要上传的文件" maxlength="180"/>
						    <input  type="hidden"  name="picType"   value="手持新银行卡照片" >
						  <input class="rz_searchbtn" type="button" name="upbtn" id="upbtn3" onclick="forupload('myfrom3')" value="上传" /></td>
						  </tr>
						  </table>
					</form>
					</tr>
                    ...
                    <form  id="myfrom4"   name="myfrom4" method="post" >
						 ...
						 <tr>
						 	...
						 	<td > <input type="file"  class="rz_input mr5" name="files" id="files4" dataType="Require" msg="请选择要上传的文件" maxlength="180"/>
						    <input  type="hidden"  name="picType"   value="其他证件证明" >
						  <input class="rz_searchbtn" type="button" name="upbtn" id="upbtn4" onclick="forupload('myfrom4')" value="上传" /></td>
						  </tr>
						  </table>
					</form>
					</tr>    		
							...
							<div class="rz_type1" style="border-top: 1px solid #dbdbdb; width: 800px;">
								<ul>
									...
									<li class="rz_ltypetxt">
										...
										<span>${p.picType}<a href="${path}/bankinfo/removePic/${n.count-1 }.html">【删除】</a></span>
									</li>
									</c:forEach>
								</ul>
							</div>
	...
	$("#"+form).ajaxSubmit({
		...
		success : function(result) {
			...
			if (result.code == '0') {
				...
				window.parent.location.href = '${path}/bankinfo/initUploadPics.html';
			}
		},
...
function subChange(obj){
	...
	layer.confirm("确定提交吗？", function() {
		var _load = layer.load('处理中..');
		$("#myfrom4").ajaxSubmit({
			url : '${basePath}/bankinfo/addChange.html',
			type : 'post',
			dataType :"json",
			success : function(result) {
				layer.close(_load);
