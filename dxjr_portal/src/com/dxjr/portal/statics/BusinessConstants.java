...
public interface BusinessConstants {
	...
	public static String ONLINE_PAY_SINAPAY_BGURL = new String("http://www.dxjr.com/autoreceive/sinapay.html"); // 服务器接受支付结果的后台
	public static String ONLINE_PAY_SINAPAY_FRONTURL = new String("http://www.dxjr.com/account/topup/sinapay/recevie.html"); // 支付成功跳转的页面
	...
	/*********************** 连连支付相关信息 开始 ***************************************/
	// 服务器接受支付结果的后台生产环境http://www.dxjr.com/account/topup/lianlianpay/autoRecevie.html测试环境http://www.dxjr.com.cn/dxjr_portal/account/topup/lianlianpay/autoRecevie.html
	public static String ONLINE_PAY_LIANLIANPAY_BGURL = new String("http://www.dxjr.com/autoreceive/lianlianpay.html"); // 服务器接受支付结果的后台
	// 支付成功跳转的页面https://www.dxjr.com/account/topup/lianlianpay/recevie.html测试环境http://www.dxjr.com.cn/dxjr_portal/account/topup/lianlianpay/recevie.html
	public static String ONLINE_PAY_LIANLIANPAY_FRONTURL = new String("http://www.dxjr.com/account/topup/lianlianpay/recevie.html"); // 支付成功跳转的页面
	...
	public static String ONLINE_PAY_LLWAP_CARD_QUERY_URL = new String("https://yintong.com.cn/traderapi/bankcardquery.htm");// 银行卡卡bin信息查询接口
	...
	public static String ONLINE_PAY_LLWAP_BGURL = new String("http://m.dxjr.com/autoreceive/lianlianpay"); // 服务器接受支付结果的后台

	public static String ONLINE_PAY_LLWAP_FRONTURL_PREFIX_M = new String("http://m.dxjr.com"); // 支付成功跳转的页面m域名
	public static String ONLINE_PAY_LLWAP_FRONTURL_PREFIX_ANDROID = new String("http://android.dxjr.com"); // 支付成功跳转的页面android域名
	public static String ONLINE_PAY_LLWAP_FRONTURL_PREFIX_IOS = new String("http://apple.dxjr.com"); // 支付成功跳转的页面android域名
	...
	/*********************** 网银在线支付相关信息 开始 ***************************************/
	public static String ONLINE_PAY_CHINABANK_INVALID_SHOPNO = "22791329"; // 公司在网银在线平台开通的商户号老账号,已失效
	// public static String ONLINE_PAY_CHINABANK_MD5KEY = "guochengjinrong22791329";// 公司在网银在线平台设置的MD5

	// 诚信贷，原商户号22899911，新商户号23234639，在新的商户号下，已经添加一下和原来一样的密钥，用户名gcjr001，密码000000
	// (2015-12-29商户号由22899911仍换成23234639)
	public static String ONLINE_PAY_CHINABANK_SHOPNO = new String("23234639"); // 公司在网银在线平台开通的商户号(新账号)
	public static String ONLINE_PAY_CHINABANK_MD5KEY = new String("guochengjinrong22899911");// 公司在网银在线平台设置的MD5

	// 网银在线自动调用本系统接口URL地址进行对账,上线需要改成https,对应192.168.1.42/dxjr_portal
	// public static String CHINABANK_AUTO_RECEVIE_URL =
	// "http://140.207.113.250:8088/dxjr_portal/account/topup/chinabank/autoRecevie.html";
	public static String CHINABANK_AUTO_RECEVIE_URL = new String("http://www.dxjr.com/autoreceive/chinabank.html");
	// 网银在线充值成功之后,系统显示的返回商户链接地址
	public static String CHINABANK_RECEVIE_URL = new String("http://www.dxjr.com/account/topup/chinabank/recevie.html");
	// public static String CHINABANK_RECEVIE_URL =
	// "http://140.207.113.250:8088/dxjr_portal/account/topup/chinabank/recevie.html";
	public static String CHINABANK_MONEY_TYPE = "CNY";// 币种
	/*********************** 网银在线支付相关信息 结束 ***************************************/

	/********************** 支付宝支付相关信息开始 *******************************************/
	public static String ALIPAY_BANK_USERNAME = "XXX";
	public static String ALIPAY_PAYMENT = "支付宝充值账号";
	public static String ALIPAY_CARDNUM = "XXXXX";
	/********************** 支付宝支付相关信息结束 *******************************************/
	...
	public static DecimalFormat aprDf = new DecimalFormat("##.##");
	...
	/*****************************************************************************************
	 * 净值额度表 类型【0：借款入账，1：网站奖励,2:还款扣除，3：还款入帐 4：垫付入帐 5：垫付后还款扣除 6：垫付还款后非VIP收取利息 7:提前还款扣除 8：提前还款入帐 9：收取罚息:10:直通车解锁 11:现金行权 12:借款标流标 13:借款标撤消 14:取消提现 15：直通车撤消 16:提现审核不通过 17：直通车流车 18：债权转让复审通过 19:债权转让撤消
	 * 20：VIP扣费 21：活期宝转出到可用余额】 begin
	 */
	...
	/*****************************************************************************************
	 * 净值额度表 类型【0：借款入账，1：网站奖励,2:还款扣除，3：还款入帐 4：垫付入帐 5：垫付后还款扣除 6：垫付还款后非VIP收取利息 7:提前还款扣除 8：提前还款入帐 9：收取罚息:10:直通车解锁 11:现金行权】 结束
	 */
	...
	/**
	 * 黑名单禁止操作类型【1：禁止手动投标，2：禁止认购直通车，3：禁止认购债权转让，4：禁止设置自动投标，5：禁止线上充值，6：禁止提现，7： 禁止发净值标, 8：直通车下车，9：禁止微信消息群推，10：禁止加入活期宝,13:禁止加入定期宝】 BEGIN
	 */
	...
	public static final Integer BLACK_TYPE_CURRENT = 10;
	public static final Integer BLACK_TYPE_TENDER_FIX_BORROW = 13;// 13:禁止加入定期宝
	/**
	 * 黑名单禁止操作类型【1：禁止手动投标，2：禁止认购直通车，3：禁止认购债权转让，4：禁止设置自动投标，5：禁止线上充值，6：禁止提现，7： 禁止发净值标, 8：直通车下车，9：禁止微信消息群推】 END
	 */
	...
	/**
	 * 直通车转让计算利息的利息 年天数 如果代收表中的利息是按照360天那么下面的应该改成360天，如果代收表中的利息是按照365天计算那么下面的就是365天 begin
	 */
	public static Integer FIRST_TRANSFER_YEAR_DAYS = 360;
	/**
	 * 直通车转让计算利息的利息 年天数 如果代收表中的利息是按照360天那么下面的应该改成360天，如果代收表中的利息是按照365天计算那么下面的就是365天 end
	 */
	...
	public static Integer CUR_OUT_TYPE_TO_BUY_STOCK = 6; // 活期宝转出购买股权
	/** 活期宝转出类型 end */
	...
	public static Integer CUR_OUT_TYPE_TO_BUY_STOCK_CAPITAL_DETAIL = 207; // 活期宝转出购买股权
	/** 活期宝转出资金明细操作类型 end */
	...
	public static String CUR_OUT_TYPE_TO_BUY_STOCK_COMMON_CAPITAL_DETAIL = "107"; // 活期宝购买股权
	 ...
	 * 充值返回平台地址
	 */
	String ONLINE_PAY_SINAPAY_RETURN_URL = new String("http://www.dxjr.com/account/topup/sinapay/recevie.html");// 页面跳转同步返回页面路径
	/**
	 * 充值回调地址
	 */
	String ONLINE_PAY_SINAPAY_NOTIFY_URL = new String("http://www.dxjr.com/autoreceive/sinapay.html");// 系统异步回调通知地址
	/**
	 ...
	 * 浙商银行资金存管机构标识
	 */
	public static String CZBANK_INSTID = "GCJR";
	/**
	 * 浙商银行资金存管数字证书标识
	 */
	public static String CZBANK_CERTID = "0012";

	/**
	 * 浙商银行资金存管机构标识
	 */
	public static String CZBANK_VERSION = "1.0.0";
}
