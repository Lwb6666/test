                ...
                <thead>
                  ...
                  <c:forEach items="${page.result}" var="fixBorrowJoinDetail" varStatus="sta">
	                  <tr>
	                    ...
	                    <td class="blue">
	                    	<fmt:formatNumber value="${fixBorrowJoinDetail.exitInterestReal }" pattern="#,##0.##" /> 
	                    </td>
	                    <td class="blue">
	                    	<fmt:formatNumber value="${fixBorrowJoinDetail.exitFee }" pattern="#,##0.##" /> 
	                    </td>
	                    <td><fmt:formatDate value="${fixBorrowJoinDetail.lockEndTime }" pattern="yyyy-MM-dd"/></td>
	                    <td><fmt:formatDate value="${fixBorrowJoinDetail.exitAddtime }" pattern="yyyy-MM-dd"/></td>
	                  </tr>
                  </c:forEach>
                  </tbody>
