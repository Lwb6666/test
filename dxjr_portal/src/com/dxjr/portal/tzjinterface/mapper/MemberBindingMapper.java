...
public interface MemberBindingMapper {
	/**
	 * 
	 * <p>
	 ...
	 * @date 2016年3月24日
	 */
	public MemberBindingVo queryMemberBindingByNameOrMobile(MemberBindingVo memberBindingVo) throws AppException;
	 ...
	 * @date 2016年3月28日
	 */
	public List<UserInfo> queryUserInfoByCnd(TzjQueryCnd cnd);
}
