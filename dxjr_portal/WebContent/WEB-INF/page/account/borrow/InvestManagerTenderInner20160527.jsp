...
<div class="men_title col2">
	<ul>
		<li id="un" class="men_li"><a href="javascript:toggleListInner('underway');">投标中的列表</a></li>
		<li id="rec" class=""><a href="javascript:toggleListInner('sucess');">投标成功列表</a></li>
	</ul>
</div>
	<div class="searchbox fl whitebg">
		<ul class="lb_title" style="border-top:none;">
			...
			<li>投标时间：<input class="inputText02" name="beginTime"
...
function findPage(pageNo) {
	window.parent.search(pageNo,'underway');
}

//查询
function queryTendering(){
	var pageNum = 1;
	window.parent.search(pageNum,'underway');
}
</script>