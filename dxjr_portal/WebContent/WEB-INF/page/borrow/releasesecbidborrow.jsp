...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table>
		...
		<tr>
			...
			<td>
				秒还
				<select name="style" id="style" onchange="ChangeStyle(this.value)" style="display:none">
	...
	<input type="hidden" name="timeLimit" id="timeLimit" value="1"/>
	</form>
	</body>
</html>
...
function insertBorrow(){
	...
	document.forms[0].action="${basePath}/borrow/secbid/insertSecBorrow.html";
