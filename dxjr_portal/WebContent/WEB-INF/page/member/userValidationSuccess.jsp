...
<!--头部开始-->
  ...
  <ul class="steps-box" style="margin-top:20px;">
      ...
      <div class="res-smbox"> <span class="title-res">注册成功</span> <span >您已获得20元红包和1次抽奖机会</span> </div >
      ...
      <div class="res-smboxs"><img src="${basePath}/images/icon-2.png"/><a href="${path}/dingqibao.html" target="_blank" class="btn-style ">去投定期宝</a></div>
        ...
        <li>
      <div class="res-smbox"> <span class="title-res">论坛连续签到${signAwardNum}天</span> <span >再得1次抽奖机会</span> </div >
