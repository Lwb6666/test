...
<!-- 		       <a href="javascript:queryTransferSubscribeList(1);">查询</a> -->
<!-- 		    </span> -->
<!-- 		</li> -->
<!-- 		<li class="tipone"> -->
...
<script type="text/javascript">
  $(function(){
	  queryTransferSubscribeList(1); 
  });
	 /*
	  * 查询转让中的债权列表
	  */
	 function queryTransferSubscribeList(pageNum){
		 var beginTime =$("#beginTime").val();
		 var endTime   =$("#endTime").val();
		 var timeScope=$('#timeScope').val(); //时间快捷查询
		 $.ajax({
				url : '${basePath}/zhitongche/zhuanrang/queryTransferSubscribeList/'+pageNum+'.html',
