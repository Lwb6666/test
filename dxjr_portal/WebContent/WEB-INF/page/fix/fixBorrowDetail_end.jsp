...
<meta name="description"
	content="顶玺金融是中国3A信用评级互联网理财借贷平台，如果你想了解更多P2P理财、网络投资理财或者资金周转借贷信息，详情请登陆www.dxjr.com。">
	...
	<div class="grid-1100">
    	<div class="product-deatil clearfix ">
            ...
            <div class="detail-col-l fl item-bd-r">
            	...
            	<ul class="item-bd-b" style="display:none">
                	<li><h6 class="f14">预期收益率 </h6><div class="percent"><span>10.0<small>%</small></span></div></li>
                    <li><h6 class="f14">投资期限 </h6><div class="percent"><span>1<small>个月</small></span></div></li>
					<li><h6 class="f14">开放额度 </h6><div class="percent"><span>4,000,00<small>元</small></span></div></li>
                    <li><h6 class="f14">投标进度</h6>
                    <div class="percent">
                        <div class="votebox" style="width:100%; display:inline-block">
                            <dl class="barbox" style="margin-top:18px">
                                <dd class="barline"  style="width:120px;">
                                    <div w="80" style="width:0px;" class="charts"></div>
                                </dd>   
                            </dl><span class="f12" style="padding-left:5px;">80%</span>
                         </div>
                     </div>
                     </li>
                </ul>
             ...
             <div class="detail-col-r fr">
             	<div class="detali-syz">
                	<div class="pd30">
                	<h5 class="f14 line32">退出日期&nbsp;&nbsp;&nbsp;&nbsp;<fmt:formatDate value="${fixBorrowVo.lockEndtime}" pattern="yyyy-MM-dd"/>   </h5>
                    <h5 class="f14 line32">累计收益 </h5>
                    <h3><span class="f36">${fixBorrowVo.sumInterest}</span><small>元</small></h3>
					<div class="btn-box">
                         <a href="#" class="btn btn-ywc f18" style="width:100%; cursor:default">已退出</a>
                    </div>
                    </div>
                </div>
             </div>
