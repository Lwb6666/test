...
public class BusinessException extends Exception {
	...
	public BusinessException(int i, String s, String s1) {
		super(s1);
		errType = "";
		errMsg = "";
		contextMsg = "";
	...
	public BusinessException(int i, String s, String s1, Throwable throwable) {
	...
	public BusinessException(int i, String s, String s1, String s2, String s3,
			Throwable throwable) {
		super(throwable.getMessage());
		errType = "";
		errMsg = "";
