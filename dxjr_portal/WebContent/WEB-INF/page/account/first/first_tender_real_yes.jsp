...
<div id="menu_column">
    <div class="men_title col2">
         <ul>
          <li><a href="javascript:queryFirstTenderRealList(0);">未解锁</a> </li>
          <li class="men_li"><a href="javascript:queryFirstTenderRealList(1);">已解锁 </a></li>
         </ul>
    </div>
</div>
	...
	<div class="myid" style="border:0px;border-top:1px solid #dbdbdb;">
		<table width="100%" border="0">
			...
			<c:forEach items="${list}" var="firstTenderReal" varStatus="sta"
				...
				<td>
				<span class="tipone"><c:if test="${firstTenderReal.parentId!=null}"><font  color='red' >【直】</font></c:if>第${firstTenderReal.orderNum}位</span>
				</td>
				<td><fmt:formatNumber value="${firstTenderReal.account}" pattern="#,##0.00"/></td>
				<td><fmt:formatDate value="${firstTenderReal.lockDate}"
						pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></td>
				<td>
				...
				<td>
					<a class="#"
					href="javascript:queryTenderRecord('${firstTenderReal.id}');">查看投标</a>|
