...
<div style="margin:0;padding:0;">
     ...
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden;"><strong>乙方（借款人）:</strong>（顶玺金融注册用户名：<label style="color: red;">${username}</label>）</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; "><strong>丙方（咨询服务方）：上海顶玺金融信息服务有限公司</strong></p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">通迅地址：上海市普陀区华池路58弄龙之梦A座32楼</p>
     
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; "><strong>鉴于：</strong></p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">1.甲、乙双方均已在顶玺金融网站注册，并承诺：在签订本合同前，甲、乙双方均已仔细阅读、充分理解并愿意遵守顶玺金融网站上与借贷有关的各项规则及说明（包括但不限于注册协议、收费规则、隐私规则及顶玺金融网站不时修订并补充的规则等），并将据此承担相应的法律责任。</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">2.甲方所有出借人现不可撤销地委托（顶玺金融注册用户名：<label style="color: red;">${businessName}</label>）作为债权人代表。该债权人代表有权代其签订与之相关的借款合同；办理、注销抵押权登记；办理公证；划拨出借款项等一系列借款相关事宜。该债权人代表应严格按照甲方的利益从事代理行为，如出现不当行为，甲方可随时更换债权人代表。</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">3.各方关系：丙方为一家合法成立并有效存续的有限责任公司，拥有 www.dxjr.com网站（以下简称“顶玺金融网站”）的经营管理权，提供借款信息咨询及管理等服务，现已实现银行资金存管及系统对接工作；甲方指将自有合法资金通过丙方出借给资金需求方的人，必须为丙方的有效注册用户，不限于单一主体，但须为自然人；乙方是指从甲方获得资金的资金需求方，必须为丙方的有效注册用户，不限于单一主体，但须为自然人、法人或其他组织。乙方有资金需求，甲方亦同意出借，双方均有意通过丙方建立借贷关系。据此，各方经充分沟通，现协商一致达成如下借款咨询与管理服务合同，以兹共同遵守。</p>
    ...
    <table style="margin: 0px auto 20px;border-collapse: collapse;border: 1px solid #838383;width:100%;font-size: 12px;">
     ...
     <td style="border: 1px solid #838383; text-align:left; padding:10px 4px;">预期利率<label style="color: red">${borrowVo.apr}%</label></td>
     </tr>
     <tr>
     ...
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（1）甲方有权根据顶玺金融网站上展示的借款人的借款信息决定是否将资金出借给乙方；若甲方决定出借资金，则甲方有权按照本合同约定获得一定的利息收益，同时应承担因乙方未归还借款而导致的利息收益及本金的损失风险；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（2）甲方明确并接受在选择银行存管类散标时，出借人偿还的借款本金可能因银行审核原因导致实际到账时间比既定还款时间迟延2个工作日，此原因导致的迟延还款不产生任何违约金，甲方不因此追究乙方或者丙方的责任；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（3）当甲方和乙方在建立债权债务关系后，甲方有权根据本合同第五条的约定将其债权转让给其他出借人（其他出借人必须是在顶玺金融网站上的注册用户），并同时转让与该债权相关的各项权利与义务；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（4）若甲方为多个出借人，且乙方所还款项或风险备用金不足以偿还全部出借人的本金、利息收益时，甲方各出借人之间应按照其借出款项的比例受偿还款；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（5）甲方对乙方的个人信息负有保密义务，承诺仅作为决定是否对其进行出借的参考，不得向任何第三方透露，否则承担由此造成的一切后果；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（6）甲方在交易过程中了解到的丙方的商业秘密、业务模式等，承诺不向任何第三方透露，且该保密义务不随本合同的终止而终止；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（7）甲方保证其用于出借的资金来源合法，并具备合法的所有权。因出借资金归属、合法性问题而引起的纠纷，甲方应自行负责解决，如甲方未能解决的，则甲方应放弃出借资金带来的收益所得。甲方保证其具有出借人的法律资格，不存在违反相关法律法规出借资金的行为；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（8）甲方在资金出借、债权转让过程中所得收益产生的相关税费，由甲方自行向主管税务机关申报、缴纳；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（9）若甲方、丙方发现有影响乙方履约能力的不利变化时（包括但不限于乙方违反本合同相关义务与承诺、乙方财产遭受没收、征用、查封、扣押、冻结等），甲方应允许丙方为保护其利益宣告本合同即刻到期并通知乙方及时还款；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（10）若乙方申请提前还款的，甲方应允许丙方代其核实、同意该申请，同时丙方可确定相应的提前还款日。</p>
     ...
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（2）乙方应按照本合同的约定按时、足额向甲方偿还本金及利息，向丙方支付借款产生的融资服务费用（融资服务费由乙丙双方另行约定），因银行审核存管资金导致借款本金迟延到达甲方指定账户，乙方不承担违约责任；</p>
     ...
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">a. 在顶玺金融网站上发布借款需求或对乙方进行信用评估或催收调查；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">b. 可将乙方的个人信息和还款情况提供给征信机构，若乙方逾期还款，丙方可将乙方身份资料及个人详细信息向有关部门或公开渠道（包括乙方所在工作单位、资信管理机构、银行或担保公司等借贷担保机构及平台、新闻媒体、顶玺金融网站“黑名单”栏目等）予以通报，实现公告催收；</p>
    ...
    <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（1）丙方有义务核实乙方的各项借款信息及资料，并有权根据乙方提供的各项信息自行决定是否在其顶玺金融网站上发布乙方的借款需求；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（2）若丙方审核通过乙方借款申请的，丙方可根据乙方的授权代乙方完成其在顶玺金融网站上的用户注册以及借款信息的发布。丙方有权对其提供的信息咨询及管理等服务向乙方收取一定的融资服务费，具体的收费标准由乙丙双方另行约定；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（3）当乙方逾期时，丙方应按照顶玺金融网站中的相关规则用其风险备用金对逾期债权进行回购，代乙方先行清偿给甲方。届时丙方即刻取得甲方在本合同项下的全部权利及主张，甲方不得再向乙方主张任何债权，此后乙方应直接向丙方偿还丙方为其先行清偿的全部款项，以及其他费用（如逾期违约金、实现债权的费用等）；</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（4）当甲方根据顶玺金融网站上的转让规则提出债权转让的，丙方应积极协助甲方进行债权的转让，并根据情况将转让事项以电子邮件或站内信息的形式通知乙方；乙方、丙方对受让人继续承担本合同项下的所有义务；</p>
    ...
    <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; "><strong>第四条：提前结清</strong></p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">1.【提前结清】借款期限内，若发生以下事项时，视为本合同项下借款需提前结清，甲乙双方均委托丙方处理结清相关事宜（包括但不限于在顶玺金融网站申请提前还款，结算及划拨本金、利息、费用等）：</p>
     ...
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">（3）若发生乙方提前还款的情况，乙方除应偿还剩余本金及利息外，还应按下列标准向甲方支付提前结清补偿金。提前结清补偿金=借款本金*{预期利率/365（日）}*2（日）</p>     
     ...
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">1.【债权转让】甲方有权将本合同中约定的债权按照顶玺金融网站的转让规则转让给第三方（该第三方须为顶玺金融网站上的注册用户）。甲方欲转让债权必须书面向丙方提出申请，待丙方审核同意后方可转让。该转让无需征得乙方同意，但丙方可在甲方同意后将转让事项以电子邮件或站内信息的形式通知乙方。债权转让后，本合同项下的其他条款不受影响，乙方仍应按照本合同的约定向债权受让人及丙方履行本合同项下所有义务。</p>
     ...
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">6.【抵押物的处置】若发生本合同第六条第5款所述的情形时，乙方同意抵押权人可选择拍卖、变卖等方式处置该抵押物，所得价款优先偿还其应还的本金、利息、逾期违约金及其他相关费用，否则抵押权人可请求人民法院拍卖抵押物。当乙方逾期时，丙方按照本合同的约定及顶玺金融网站中的相关规则先行向甲方履行清偿义务的，届时丙方成为新的债权人，有权就该抵押物拍卖、变卖所得的价款优先受偿。无论何种方式，若处置抵押物所得不足以清偿抵押担保范围内的全部债权的，债权人有权向乙方及其连带保证人追索不足部分；若清偿后有所剩余的，丙方应将剩余部分退还给乙方或其连带保证人。</p>
     ...
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">1.【合同形式】本合同正文通过顶玺金融网站以电子文本形式制成，可有一份或者多份并且每一份均具有同等法律效力。本合同经甲乙双方在丙方的顶玺金融网站上以点击确认的方式订立，甲乙双方均委托丙方在其专有服务器上保管本合同，并认可该形式的电子合同的效力。本合同纸质档由甲方（债权人代表）、乙方、丙方三方共同签署后保存在丙方处，丙方应妥善保管该合同文本。三方共同签署同时，顶玺金融网站上的相关规则、甲乙双方在顶玺金融网站上确认的电子协议（如注册协议等）以及乙方因借款所签署的所有纸质文件（如申请表、授权书等）均为本合同不可分割的组成部分，与本合同具有同等的法律效力。</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">2.【合同成立及生效】各方同意并确认，各方通过自行或授权有关方根据顶玺金融网站中的有关规则和说明，在顶玺金融网站进行借款申请或投标操作等方式确认签署本合同，待丙方审核通过后，本合同立即成立；当乙方在顶玺金融网站发布的借款信息满标且其银行账户中收到本合同约定的借款金额之日起，本合同生效，开始计算借款期限、利息及支付融资服务费。</p>
     ...
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">5.【信息通知】丙方对甲乙双方的通知将以手机短信、电子邮件、顶玺金融网站站内信或顶玺金融网站公告等形式进行。</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">6.【合同修订】合同各方同意顶玺金融网站根据情况不时对本合同版本进行变更及修订，并同意按照更新版本享有权利及承担义务。本合同的最终解释权归丙方所有。</p>
     
     <p style="page-break-after:always">&nbsp;</p>
     
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden;">甲方：（&lt;出借人名单&gt;详见附件一）</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden;">日期：${borrowVo.successTimeDate?string('yyyy年MM月dd日')}</p>
     <p style="height:50px;">&nbsp;</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden;">乙方：${username}</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden;">日期：${borrowVo.successTimeDate?string('yyyy年MM月dd日')}</p>
     <p style="height:50px;">&nbsp;</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden;">丙方：上海顶玺金融信息服务有限公司</p>
     <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden;">日期：${borrowVo.successTimeDate?string('yyyy年MM月dd日')}</p>
    ...
    <p style="padding:0px 10px 10px 10px; line-height:2em;overflow-x:hidden; ">附件一：出借人名单</p>
      ...
      <td style="border: 1px solid #838383; padding:10px 4px;" width="20%" align="center">预期利率</td>      
      ...
      <#if tenderRecordVoList?exists>
	      ...
	      <tr>
	        <td align="left" style="border: 1px solid #838383; padding:10px 4px;">
				...
				<#else>
					<label style="color: red">
			        	<#if userId == tenderRecordVo.userId>
		  					${tenderRecordVo.username?replace('&','&amp;')}
						<#else>
			  				${tenderRecordVo.userNameSecret}
			  	  		</#if>
		        	</label>
				</#if>	        	
	        </td>
	        ...
	        <td align="left" style="border: 1px solid #838383; padding:10px 4px;"><label style="color: red">￥${tenderRecordVo.repaymentAccount?string} </label></td>
	      </tr>
	      </#list>
      </#if>
      <tr>
