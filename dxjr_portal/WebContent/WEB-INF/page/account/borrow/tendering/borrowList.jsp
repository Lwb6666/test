...
<div id="Bmain">
  <div id="Bmain_titile">
  	<div class="title"><span class="home"><a href="${path}/">顶玺金融</a></span><span><a href="${path}/myaccount/toIndex.html">我的账户</a></span><span> 融资管理</span><span><a href="${path }/myaccount/toTendering.html">融资列表</a></span></div>
        <div id="menu_centert">     
...
function queryTendering(pageNum, pageSize){
	...
	$.ajax({
		url : '${basePath}/myaccount/queryAll.html',
		data :{
