...
import com.dxjr.common.PropertyUtil;
...
public class TicketCryptor {
	...
	private static String COOKIE_KEY= "sso.cookie.key";
	private static String SYS_CONFIG_FILE = "system.properties"; 
	private static CompositeConfiguration pConfig=PropertyUtil.getConfig(SYS_CONFIG_FILE);
	private static final byte[] KEY = getBytes(pConfig.getString(COOKIE_KEY));
