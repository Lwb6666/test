		...
		<tr>
			...
			<td>
				...
				<span id="daylimit" style="display:none">
					<input type="text" name="timeLimitday" id="timeLimitday" size="20" maxlength="3"/>
				</span>
...
function insertBorrow(){
	...
	document.forms[0].action="${basePath}/rongzi/insertNetValueBorrow.html";
	document.forms[0].submit();
}

function ChangeStyle(value){
	if(value=='${payinstalment}'){
