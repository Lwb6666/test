	...
	<div class="grid-1100">
    	<div class="product-deatil clearfix ">
            ...
            <div class="detail-col-l fl item-bd-r">
	            ...
	            <label style="color: #333;">${bTransfer.transferName}</label></span>&nbsp;&nbsp;<a  href="${path}/accountdetail/show.html?userName=${portal:encode(portal:encode(bTransfer.userNameEncrypt))}"   target="_blank"><span class="bule">${bTransfer.userNameSecret}</span></a></div>
                <div class="ptb-list clearfix">
                	<p><span>债权价格</span><label><strong class="f20 oren"><fmt:formatNumber value="${bTransfer.account}" pattern="#,##0.##"/></strong>元</label>
	                   <span class="dj-box" onmousemove="$(this).find('i').show();" onmouseout="$(this).find('i').hide();">
	                		...
	                		<i style="display:none;">此债权的剩余价值为<fmt:formatNumber value="${bTransfer.accountSurplus}" pattern="#,##0.##"/>元<br>其中剩余本金<fmt:formatNumber value="${bTransfer.capital}" pattern="#,##0.##"/>元<br>待收利息<fmt:formatNumber value="${bTransfer.accountSurplus-bTransfer.capital}" pattern="#,##0.##"/>元 </i>
	                   </span>
                	</p>
             ...
             <div class="detail-col-r fr">
             	...
             	<div class="detail-join-m">
                    ...
                    <a href="${path}/account/topup/toTopupIndex.html" class="fr bd">充值</a>
                    	...
                    	<c:if test="${loginMember==null}"><a href="${path}/member/toLoginPage.html?backUrl=1" class="pdla login">登录</a>后可见</c:if>
                    	</span>
                    </div>
                    <c:if test="${loginMember!=null}">
                    <div class="clearfix pdt10">
                    ...
                    <div class="clearfix pdt10 pd20"><span class="f14 pdra">购买金额</span><input class="form-inpyt-sm yuan2"   style="width:160px;color:#999;" type="text" onblur="if(value==''){value='50元起投';$('#pay_money').attr('style','color:#999;width:160px;');}" onfocus="if(value=='50元起投'){value='';$('#pay_money').attr('style','color:#FFFFF;width:160px;'); }"  value="50元起投"  name="tenderMoney" id="pay_money"><a href="javascript:enterMomey();" style="padding:2px 0 0 10px;">全额加入</a> </div>
	...
	<div class="grid-1100">
    	<div class="product-deatil clearfix ">
    	  ...
    	  <div class="detail-col-l fl item-bd-r">
	          ...
	          <a style="color: #333;" href="${path}/toubiao/${borrow.id}.html" target="_blank"> ${fn:substring(borrow.name,0,25)}<c:if test="${fn:length(borrow.name)>25}">..</c:if> </a></span>
	          <span class="bule">
		          <a class="bule" href="${path}/accountdetail/show.html?userName=${portal:encode(portal:encode(borrow.userNameEncrypt))}" target="_blank">
		          <c:choose>
           	  ...
           	  <ul class="item-bd-b">
                	<li class="bdr percentbig"><span class="f14 gary">预期收益率</span><span class="oren precent line120"><fmt:formatNumber value="${borrow.apr}" pattern="#,##0.##"/><small class="f18 oren">%</small></span></li>
	...
	<div class="cont-word">
        ...
        <%-- 	<div class="form-col2">
            ...
            <div class="form-col2">
                ...
                <input type="password"  id="bidPassword" name="bidPassword"  class="form-inpyt-sm1"  style="display:none;width:120px;color:#999;"/> <a href="javascript:void(0);" class="fl pdlr10 line32"> </a>
            </div>
            </c:if>
     <%--        <div class="form-col2">
