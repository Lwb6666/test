package com.dxjr.portal.collection.vo;
 ...
 */
public class BCollectionRecordVo implements Serializable {
    ...
    private BigDecimal advanceYesaccount; //实际垫付金额
    private Integer firstTenderRealId;   //优先投标最终认购记录id
