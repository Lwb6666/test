...
public class BTransferVo extends BTransfer implements Serializable {
	...
	public String getBorrowTimeLimitStr() {
		return super.getBorrowTimeLimit().toString();
	}
	...
	public String getUseStr() {//用途【1:短期周转 2:生意周转 3:生活周转 4:购物消费 5:创业借款 6:其它借款】'
		 
		switch (use) {
		case 1:useStr="短期周转";break;
		case 2:useStr="生意周转";break;
		case 3:useStr="生活周转";break;
		case 4:useStr="购物消费";break;
		case 5:useStr="创业借款";break;
		case 6:useStr="其它借款"; break;
		default:useStr="其它借款";
			break;
		}
		return useStr;
	...
	public String getRepayTimeStr() {
		if (repayTime != null && !"".equals(repayTime)){
			if(super.getBorrowStyle()==1||super.getBorrowStyle()==2){
			   return "每月"+DateUtils.timeStampToDate(repayTime,DateUtils.D)+"日";
			}
			if(super.getBorrowStyle()==3||super.getBorrowStyle()==4){
				return DateUtils.timeStampToDate(repayTime,DateUtils.YMD_NYRSH);
			}
		}
		return null;
	}
	...
	public String getBorrowTime() {
		if (borrowTime != null && !"".equals(borrowTime)){
			return DateUtils.timeStampToDate(borrowTime,DateUtils.YMD_NYRSH);
		}
		return borrowTime;
	}
	
	public String getDateBorrowTime() {		
		return borrowTime;
	}
