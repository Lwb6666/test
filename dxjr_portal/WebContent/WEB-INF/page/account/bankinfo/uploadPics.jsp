...
<div class="title"><h4>解绑银行卡</h4><a onclick="closeUpDateBankCard1();" class="icon icon-close fr"></a></div>
<div class="form-info-layer">
	    ...
	    <div>
              <button type="button" class="remove" onclick="closeUpDateBankCard1();">取消</button>
...
function deletePic(id) {
		$.ajax({
			url : "${path}/bankinfo/removePic1/"+id+".html",
			data :{
			} ,
			type : 'post',
			dataType :"json",
