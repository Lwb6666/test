...
public class MoneyUtil {
	...
	/**
	 * <p>
	 * Description:用千位分隔金融，保留saleCount小数，进行roundDown<br />
	 * </p>
	 * 
	 * @author 邹理享
	 * @version 0.1 2015年2月28日
	 * @param money
	 * @param saleCount
	 * @param roundDown
	 * @return String
	 */
	public static String roundMoney(BigDecimal money, int saleCount, int roundDown) {
		String result = "0";
		if (null == money) {
			return result;
		}
		money = money.setScale(saleCount, roundDown);
		DecimalFormat d = new DecimalFormat(",##0.00");
		return d.format(money);
	}
