...
<form id="payPwdForm" name="payPwdForm"  method="">
	<div class="cont-word">
    	<div class="title"><h4>修改交易密码</h4><a href="javascript:void(0);" onclick="closeUpdatePayPwd();"  class="icon icon-close fr"></a></div>
        <div class="form-info-layer">
            <div class="form-col2">
                <label for="" class="colleft02 form-lable">当前交易密码</label>
                <input type="password"  style="width:198px" class="colright form-inpyt-sm" placeholder="请输入当前交易密码"
                id="oldPwd" name="oldPwd" dataType="Limit" min="1"  msg="当前密码不能为空" >
            </div>
            <div class="form-col2">
                <label for="" class="colleft02 form-lable">新交易密码</label>
                <input type="password" style="width:198px" class="colright form-inpyt-sm" placeholder="请输入新的交易密码"
                id="newPwd" name="newPwd" dataType="Limit" min="6" max="12" msg="新密码不能为空，且长度在6~12之间" maxlength="12" >
            </div>
            <div class="form-col2">
                <label for="" class="colleft02 form-lable">确认交易密码</label>
                <input type="password" style="width:198px" class="colright form-inpyt-sm" placeholder="确认交易密码"
            ...
            <div class="form-col2">
            <button type="button" class="remove" onclick="closeUpdatePayPwd();">取消</button><button type="button" class="enter" id="submitBtn" onclick="save();">确定</button>
            </div>
         </div>
    </div> 
</form>
