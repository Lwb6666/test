...
<!--内容开始-->
	<div id="Bmain">
		<div class="title">
			...
			<span><a href="${path}/toubiao.html">普通标</a></span>
				...
				<div class="rztitle">筛选投资项目</div>
					...
					<table id="investTable">
						...
						<td class="rz_font">标的类型：</td>
                         	 <td><span class="tbp_btn selected borrowType"><a href="javascript:void(0);" borrowType=''>不限</a></span></td>
	                         <td><span class="tbp_btn borrowType"><a href="javascript:void(0);" borrowType='2'>资产抵押标</a></span></td>
	                         <td><span class="tbp_btn borrowType"><a href="javascript:void(0);" borrowType='5'>机构担保标</a></span></td>
	                         <td><span class="tbp_btn borrowType"><a href="javascript:void(0);" borrowType='1'>信用认证标</a></span></td>
                        </tr>
                        
                           <tr>
                                <td class="rz_font">标的状态：</td>
                                <td><span class="tbp_btn selected limitTime"><a href="javascript:void(0);" limitTime=""  >不限</a></span></td>
                                <td><span class="tbp_btn limitTime"><a href="javascript:void(0);" limitTime="isAdvanced"  >预发 </a></span></td>
                                <td><span class="tbp_btn  limitTime"><a href="javascript:void(0);" limitTime="isTendering"  >投标中</a></span></td>
              ...
              <div class="tbsort"  >
                    ...
                    <tr>
                     <td width="44%" colspan="4"> 
	                       <div class="tbborde" style="width:440px">
	                           <a class="tbhove tbnone sec" href="${path}/toubiao.html">普通标</a> 
               ...
               <div id="rz_main" style="margin-top:0">
                                ...
                                <span class="top"><h3>投标列表&nbsp; 
                                 ...
                                 <a href="${path }/borrow/calculator/toCounter.html">
                                 <input type="button" class="but dgreen" value="理财计算器" style="cursor: pointer;" /></a>
                                 <input type="button" class="but dgreen" value="自动投资" style="margin-left:15px;" onclick="automaticTender();" />
...
$(document).ready(function(){
		...
		//var borr= $(".borrowType").children("a").attr("borrowType"); //赋值
		if(""!=BorrowType){
			$(".borrowType").find("a").each(function(index,element){
				$(element).parent().removeClass("selected");
				if($(element).attr("borrowType")==BorrowType){
					$(element).parent().addClass("selected"); //给当前节点添加class
				}
			});
		}
