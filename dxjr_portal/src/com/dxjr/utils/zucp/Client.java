...
public class Client {
	...
	private String serviceURL = "http://117.79.237.29:8060/webservice.asmx";
	 ...
	 */
	public String register(String province, String city, String trade, String entname, String linkman, String phone, String mobile, String email, String fax,
	...
	/*
	 * 方法名称：mt 功 能：发送短信 ,传多个手机号就是群发，一个手机号就是单条提交 参 数：mobile,content,ext,stime,rrid(手机号，内容，扩展码，定时时间，唯一标识) 返 回 值：唯一标识，如果不填写rrid将返回系统生成的
	 */
	...
	/*
	 * 方法名称：gxmt 功 能：发送个性短信 ，即给不同的手机号发送不同的内容，手机号和内容用英文的逗号对应好 参数：mobile,content,ext,stime,rrid(手机号，内容，扩展码，定时时间，唯一标识) 返 回 值：唯一标识，如果不填写rrid将返回系统生成的
	 */
	...
	/*
	 * 方法名称：mdSmsSend_u 功 能：发送短信 ,传多个手机号就是群发，一个手机号就是单条提交 参 数：mobile,content,ext,stime,rrid(手机号，URL_UT8编码内容，扩展码，定时时间，唯一标识) 返 回 值：唯一标识，如果不填写rrid将返回系统生成的
	 */
	public String mdSmsSend_u(String mobile, String content, String ext, String stime, String rrid) {
		if (mobile == null || "".equals(mobile) || "88888888888".equals(mobile))
			return "";
