...
<div class="men_title col2">
	<ul>
		...
		<li id="rec" ><a href="javascript:toggleListInner('rec');">已收明细 </a></li>
	</ul>
</div>
		...
		<div class="searchbox fl  whitebg">
			<ul class="lb_title nobordertop">
				<li>借款人：<input class="inputText02" name="keyword" id="keyword"
					value="${keyword}"></li>
				<li>应收款时间： <input class="inputText02" name="beginTime"
				...
				<li class="lb_culi"><span class="lb_title_btn"><a
						href="javascript:forqueryrecord('unCollection_record');">查询</a></span></li>
				<li class="lb_culi"><span class="lb_title_btn"><a
	...
	<div class="myid whitebg">
		<table border="0">
			...
			<c:forEach items="${CollectionRecordList}" var="collectionRecord"
				...
				<td width="154"> <c:if test="${collectionRecord.parentId!=null}"><font  color='red' >[转]</font></c:if> <a title='${collectionRecord.name }'
				...
				<td width="98" class="numcolor">${collectionRecord.repayAccountStr}
					元</td>
