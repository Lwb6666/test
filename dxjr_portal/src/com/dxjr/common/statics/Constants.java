package com.dxjr.common.statics;
...
public interface Constants {
	...
	public String[] IDC_IPS = { "144.144.144.144", "144.144.144.145" };

	/** 账户状态（-1：账号注销 -2:待审核 -3：审核不通过 0：正常状态） begin */
	public Integer MEMBER_STATUS_NORMAL = 0;
	public Integer MEMBER_STATUS_REJECT = -3;
	public Integer MEMBER_STATUS_UNAUDIT = -2;
	public Integer MEMBER_STATUS_CANCELLED = -1;
	/** 账户状态（-1：账号注销 -2:待审核 -3：审核不通过 0：正常状态） end */
	...
	/*
	 * 积分的类型(0登陆 1发帖 2 回复 3领工资/签到 4精华帖 5收藏 6顶贴 7邀请 8加好友,9考察报告,10首充1000积分奖励,11网站奖励) begin
	 */
	...
	/*
	 * 积分的类型(0登陆 1发帖 2 回复 3领工资 4精华帖 5收藏 6顶贴 7邀请 8加好友,9考察报告,10首充1000积分奖励 11网站奖励) end
	 */
	...
	public static int ONLINE_TYPE_FUIOUPAY = 6;// 富友支付
	public static String ONLINE_TYPE_FUIOUPAY_NAME = "富友支付";// 富友支付
    public static int ONLINE_TYPE_CZBANK = 8;// 浙商存管
    public static String ONLINE_TYPE_CZBANK_NAME = "浙商存管";// 浙商存管
	/************************ 第三方支付平台设置 开始 结束 *****************************************/
	...
	/********************** 提现记录状态 -1：审核失败；0：申请提现；1：审核通过；2：打款结束 3:取消提现】 开始 ********************/
	...
	/********************** 提现记录状态 -1：审核失败；0：申请提现；1：审核通过；2：打款结束】 结束 ********************/

	/**
	 * 优选计划状态 begin 0:草稿标 1：新标,审核中，2：审核不通过，3：审核通过投标中，4：满标复审中，5：满标审核通过，6：满标审核拒绝，-1 ：流标，-2：被撤销,-3:已过期,-4:已删除
	 */
	...
	/**
	 * 操作类型， begin 0 ：发布审核 1：满标审核 2：提前满直通车审核 3上下车满车
	 */
	public static Integer APPROVE_STYLE_NEW_APPROVE = 0;
	public static Integer APPROVE_STYLE_SUCCESS_APPROVE = 1;
	public static Integer APPROVE_STYLE_ADVANCE_SUCCESS_APPROVE = 2;
	public static Integer APPROVE_STYLE_UP_OR_DOWN = 3;
	/**************** 审核类型 end *************/
	...
	/**
	 * 优先投标计划最终开通 状态 begin 状态 0 ：未失效 1 ：已失效 2:解锁中 3:转让中 4：已转让
	 */
	...
	public static Integer TENDER_REAL_STATUS_TRANSFERING = 3;
	public static Integer TENDER_REAL_STATUS_TRANSFER_SUCCESS = 4;
	/************** 优先投标计划开通明细 投标状态 end */
	...
	/******************** 0:借款标ID, 1:直通车id, 2:待还记录id，3:直通车转让ID， 4：活期宝转出ID 开始 **************************************/
	...
	public static final Integer ACCOUNT_LOG_ID_TYPE_FIRST_TRANSFER = 3;
	public static final Integer ACCOUNT_LOG_ID_TYPE_CUR_OUT = 4;
	...
	/******************** 提现操作日志 操作类型（3:取消提现) begin ****************************************************/
	public static final Integer CASHRECORD_LOG_TYPE_CANCEL = 3;

	/******************** 提现操作日志 操作类型（3:取消提现) end ****************************************************/

	/********************* 借款标提前满标日志 操作类型 1:提前满标 2：撤标 begin ******************************************/
	public static final Integer BORROW_ADVANCE_LOG_TYPE_SUCCESS = 1;
	public static final Integer BORROW_ADVANCE_LOG_TYPE_CANCEL = 2;

	/********************* 借款标提前满标日志 操作类型 1:提前满标 2：撤标end ******************************************/
	...
	/********************* 投标状态（ -1：所投标失败 ，0：正在投标 ，1：所投标还款中 ，2：所投标完成结束）begin ********************/
	public static Integer TENDER_RECORD_STATUS_FAILER = -1;
	public static Integer TENDER_RECORD_STATUS_TENDRING = 0;
	public static Integer TENDER_RECORD_STATUS_REPAY = 1;
	public static Integer TENDER_RECORD_STATUS_FINISH = 2;
	/********************* 投标状态（ -1：所投标失败 ，0：正在投标 ，1：所投标还款中 ，2：所投标完成结束）end ********************/
	...
	/****************** 直通车转让状态(1：直通车转让，审核中，2：转让中，3：转让复审中，4：转让完成，5：转让流车，6：被撤销 ，7：复审失败 begin */
	public static final Integer FIRST_TRANSFER_STATU_NEW_WAIT = 1;
	public static final Integer FIRST_TRANSFER_STATU_ING = 2;
	public static final Integer FIRST_TRANSFER_FULL_RECHECK = 3;
	public static final Integer FIRST_TRANSFER_SUCCESS = 4;
	public static final Integer FIRST_TRANSFER_FLOW = 5;
	public static final Integer FIRST_TRANSFER_CANCEL = 6;
	public static final Integer FIRST_TRANSFER_STATU_CHECK_FAIL = 7;
	/****************** 直通车转让状态(1：直通车转让，审核中，2：转让中，3：转让复审中，4：转让完成，5：转让流车，6：被撤销 ，7：复审失败 end */

	/**************** 直通车转让审核状态（1： 等待审核 2：初审不通过 ，3：初审通过 4： 复审不通过 5：复审通过） begin */
	public static final Integer FIRST_TRANSFER_APPROVED_WAIT = 1;
	public static final Integer FIRST_TRANSFER_APPROVED_ONE_REJECT = 2;
	public static final Integer FIRST_TRANSFER_APPROVED_ONE_PASS = 3;
	public static final Integer FIRST_TRANSFER_APPROVED_RECHECK_REJECT = 4;
	public static final Integer FIRST_TRANSFER_APPROVED_RECHECK_PASS = 5;
	/**************** 直通车转让审核状态（1： 等待审核 2：初审不通过 ，3：初审通过 4： 复审不通过 5：复审通过） end */

	/**************** 系统来源（1: portal 2:console 3:系统自动） begin */
	public static final Integer SYSTEM_PORTAL = 1;
	public static final Integer SYSTEM_CONSOLE = 2;
	public static final Integer SYSTEM_AUTO = 3;
	/**************** 直通车转让审核系统来源（1: portal 2:console 3:系统自动）） end */

	/**************** 直通车转让日志类型（1：新增、2：撤消、3、转让成功、4、流转 5：复审失败） begin */
	public static final Integer FIRST_TRANSFER_LOG_TYPE_INSERT = 1;
	public static final Integer FIRST_TRANSFER_LOG_TYPE_CANCEL = 2;
	public static final Integer FIRST_TRANSFER_LOG_TYPE_SUCCESS = 3;
	public static final Integer FIRST_TRANSFER_LOG_TYPE_FLOW = 4;
	public static final Integer FIRST_TRANSFER_LOG_TYPE_RECHECK_REJECT = 5;
	/**************** 直通车转让日志类型（1：新增、2：撤消、3、转让成功、4、流转 5：复审失败） end */
	...
	/**
	 * 定期宝 begin 0:草稿标 1：新标,审核中，2：审核不通过，3：审核通过投标中，4：满标复审中，5：满标审核通过，6：满标审核拒绝，-1 ：流标，-2：被撤销,-3:已过期,-4:已删除
	 */
	...
	/**************** 定期宝提前退出状态 start *************/
	/**
	 * 状态(-2：撤销；-1：审核不通过；0：申请中；1：审核通过；2：转让中；3：转让完成；4：已还款)
	 */
	Integer FIX_EXIT_STATUS_CANCEL = -2;
	Integer FIX_EXIT_STATUS_NOPASS = -1;
	Integer FIX_EXIT_STATUS_APPLY = 0;
	Integer FIX_EXIT_STATUS_PASS = 1;
	Integer FIX_EXIT_STATUS_TRANSFER= 2;
	Integer FIX_EXIT_STATUS_TRANSFERFINISH=3;
	Integer FIX_EXIT_STATUS_REPAY=4;
	/**************** 定期宝提前退出状态 end *************/

	/**************** 定期宝最终认购记录状态状态 start *************/
	/**
	 * 状态  0 ：锁定中 1:还款结束 2：申请退出中
	 */
	Integer FIX_TENDER_REAL_STATUS_LOCK = 0;
	Integer FIX_TENDER_REAL_STATUS_REPAL = 1;
	Integer FIX_TENDER_REAL_STATUS_EXIT = 2;
	/**************** 定期宝最终认购记录状态状态 end *************/
}
