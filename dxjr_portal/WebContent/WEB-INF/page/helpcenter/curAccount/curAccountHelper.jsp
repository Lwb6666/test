...
<title>顶玺金融_帮助中心_如何投资_活期宝</title>
</head>
<body>
		...
		<div id="Bmain">
			<div class="title">
				<span class="home"><a href="${path}/">顶玺金融</a></span> <span><a href="${path }/bangzhu.html">帮助中心</a></span> <span><a
					href="${path }/bangzhu/touzi.html">如何投资</a></span> <span><a href="${path }/bangzhu/23.html">活期宝</a></span>
			</div>
			...
			<div id="menu_centert">
				...
				<div id="helpctr">
					...
					<div class="content" style="display: block;">
						<%@ include file="/WEB-INF/page/helpcenter/curAccount/curAccountHelperDiv.jsp"%>
					</div>
				</div>
