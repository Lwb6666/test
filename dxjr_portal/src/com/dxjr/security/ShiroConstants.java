...
public interface ShiroConstants extends Constants {
	...
	// 权限
	public static final Map<String, List<String>> permissions = ImmutableMap.of(
		ROLE_BORROW, Arrays.asList(new String[] { PERMISSION_BORROW }),
		ROLE_INVEST, Arrays.asList(new String[] { PERMISSION_INVEST })
	);
}
