...
public class BankUtil {
	...
	/** 网银在线手机支付银行 **/
	public static Map<String, String> onlineWayBankMap = new HashMap<String, String>();
	static {
		onlineWayBankMap.put("ICBC", "工商银行");
		onlineWayBankMap.put("CCB", "建设银行");
		onlineWayBankMap.put("BOC", "中国银行");
		onlineWayBankMap.put("ABC", "农业银行");
		onlineWayBankMap.put("BCM", "交通银行");
		onlineWayBankMap.put("PSBC", "邮储银行");
		onlineWayBankMap.put("CMB", "招商银行");
		onlineWayBankMap.put("CITIC", "中信银行");
		onlineWayBankMap.put("SPDB", "浦东发展银行");
		onlineWayBankMap.put("CIB", "兴业银行");
		onlineWayBankMap.put("CMBC", "民生银行");
		onlineWayBankMap.put("CEB", "光大银行");
		onlineWayBankMap.put("PAB", "平安银行");
		onlineWayBankMap.put("HXB", "华夏银行");
		onlineWayBankMap.put("BOB", "北京银行");
		onlineWayBankMap.put("CGB", "广发银行");
		onlineWayBankMap.put("BOS", "上海银行");
		onlineWayBankMap.put("JSB", "江苏银行");
		onlineWayBankMap.put("BJRCB", "北京农商银行");
		onlineWayBankMap.put("CQRCB", "重庆农商行");
		onlineWayBankMap.put("SRCB", "上海农商行");
		onlineWayBankMap.put("NJCB", "南京银行");
		onlineWayBankMap.put("GRCB", "广州农商银行");
		onlineWayBankMap.put("NBCB", "宁波银行");
		onlineWayBankMap.put("HSB", "徽商银行");
		onlineWayBankMap.put("HZB", "杭州银行");
		onlineWayBankMap.put("GZCB", "广州银行");
		onlineWayBankMap.put("BODL", "大连银行");
		onlineWayBankMap.put("BSB", "包商银行");
		onlineWayBankMap.put("BOCD", "成都银行");
		onlineWayBankMap.put("BOLJ", "龙江银行");
		onlineWayBankMap.put("HKB", "汉口银行");
		onlineWayBankMap.put("CQCB", "重庆银行");
		onlineWayBankMap.put("CHAB", "山东联盟-长安银行");
		onlineWayBankMap.put("TAB", "泰安市商业银行");
		onlineWayBankMap.put("RZB", "日照银行");
		onlineWayBankMap.put("WFCCB", "潍坊银行");
		onlineWayBankMap.put("LSB", "临商银行");
		onlineWayBankMap.put("LWB", "莱商银行");
		onlineWayBankMap.put("DZB", "德州银行");
		onlineWayBankMap.put("QSB", "齐商银行");
		onlineWayBankMap.put("DYLSCZ", "东营莱商村镇银行");
		onlineWayBankMap.put("CJCCB", "长江银行");
		onlineWayBankMap.put("BOLY", "洛阳银行");
		onlineWayBankMap.put("GDNYB", "广东南粤银行");
		onlineWayBankMap.put("JZCB", "晋中银行");
		onlineWayBankMap.put("ORDOS", "鄂尔多斯银行");
		onlineWayBankMap.put("BOXM", "厦门银行");
		onlineWayBankMap.put("WZCB", "温州银行");
		onlineWayBankMap.put("BONC", "南昌银行");
		onlineWayBankMap.put("JJCCB", "九江银行");
		onlineWayBankMap.put("HBNX", "河北省农村信用社");
		onlineWayBankMap.put("HUBNX", "湖北省农村信用社");
		onlineWayBankMap.put("GSNX", "甘肃省农村信用社");
		onlineWayBankMap.put("SHXNX", "陕西省农村信用社");
		onlineWayBankMap.put("BHRCB", "天津滨海农村商业银行");
	}

	/**
	 * 网银在线获取银行名称
	 * @author WangQianJin
	 * @title @param bankCode
	 * @title @return
	 * @date 2016年6月4日
	 */
	public static String getOnlineBankNameByBankCode(String bankCode) {
		String bankName = "";
		if (onlineWayBankMap.containsKey(bankCode)) {
			bankName = onlineWayBankMap.get(bankCode);
		}
		return bankName;
	}
