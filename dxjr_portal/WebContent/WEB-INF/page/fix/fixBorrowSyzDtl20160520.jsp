        ...
        <div class="fl" style="margin: 10px 0 10px 0;width:100%;">
          <div class="dqb-column-div">
            <ul>
              ...
              <li style="font-size: 24px;line-height: 40px;">
             <fmt:formatNumber value="${fixTenderRealVo.apr}" pattern="##.##"/>%</li>
            </ul>
            <ul>
              <li style="line-height:40px;">加入金额</li>
              <li style="line-height:40px;"><fmt:formatNumber value="${fixTenderRealVo.account}"
      pattern="#,##0.00" />元</li>
            </ul>
          ...
          <div class="dqb-column-div">
            ...
            <ul>
              ...
              <li style="line-height:40px;">
               <fmt:formatDate value="${fixTenderRealVo.lockEndTime}" pattern="yyyy-MM-dd"/>
               
            </ul>
          </div>
         
         <div class="dqb-status">收益中</div>
