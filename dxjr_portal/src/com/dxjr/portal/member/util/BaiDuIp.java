...
public class BaiDuIp {
	 ...
	 */
	public static final IpAddr queryAddrByIp_bak(String ip) {
		String url = new StringBuffer(112)
					.append("http://opendata.baidu.com/api.php?resource_id=6006&ie=utf8&oe=gbk&t=")
...
//			String result = HttpURLUtil.doPost(url, null);
	...
	static class Baidu {
		...
		private String t;
		private List<Data> data = new ArrayList<>(0);
