package com.dxjr.common.interceptor;
...
import com.dxjr.common.dialect.DatabaseDialects;
import com.dxjr.common.dialect.Dialect;
import com.dxjr.common.dialect.MySQLDialect;
import com.dxjr.common.dialect.OracleDialect;
import com.dxjr.common.page.Page;
import com.dxjr.common.page.PageCnd;
...
public class PaginationInterceptor implements Interceptor {
	...
	private BoundSql buildNewBoundSql(Configuration configuration, BoundSql boundSql, String newSql, int offset, int limit) {
		...
		if (parameterObject == null) {
		...
		} else if (parameterObject instanceof String || parameterObject instanceof Integer || parameterObject instanceof Long || parameterObject instanceof Double || parameterObject instanceof Float
				|| parameterObject instanceof Short || parameterObject instanceof Byte || parameterObject instanceof Date || parameterObject instanceof java.sql.Date
				|| parameterObject instanceof Timestamp || parameterObject instanceof Boolean) {
			...
			throw new RuntimeException("unknown type exception: instance of the parameter object is not a common type of java or not extends BaseCnd(implements PageCnd) - "
