...
public class Uploader {
	...
	public static final String[] default_img_allowFiles = { ".gif", ".png",
			".jpg", ".jpeg", ".bmp" };
	...
	public void upload() throws Exception {
		...
		try {
			...
			this.state = errorInfo.get("SIZE") + "(<=" + (this.maxSize / 1024)
					+ "MB)";
		} catch (InvalidContentTypeException e) {
			this.state = errorInfo.get("ENTYPE");
		} catch (FileUploadException e) {
			this.state = errorInfo.get("REQUEST");
		} catch (Exception e) {
