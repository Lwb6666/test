...
<div class="lb_waikuang whitebg" style="margin:1px">
	<ul class="lb_title nobordertop">
		...
		<li class="lb_culi">
		    <span class="lb_title_btn">
		       <a href="javascript:queryCanTransferList(1);">查询</a>
		    </span>
		</li>
		<li class="tipone">
	...
	<div class="myid whitebg nobordertop" id="canTransferDiv">
...
<script type="text/javascript">
  $(function(){
	  queryCanTransferList(1); 
  });
	 /*
	  * 查询可转让的债权列表
	  */
	 function queryCanTransferList(pageNum){
		 var beginTime =$("#beginTime").val();
		 var endTime   =$("#endTime").val();
		 $.ajax({
				url : '${basePath}/zhitongche/zhuanrang/queryCanTransferList/'+pageNum+'.html',
				data:{beginTime:beginTime,endTime:endTime},
				type : 'post',
				dataType :"html",
				success : function(result) {
					$("#canTransferDiv").html(result);
				},
