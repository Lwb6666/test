...
public class FixBorrow {
	 ...
	 * 最后修改人
	 */
	private Integer lastModifylUser; 
	...
	public Integer getLastModifylUser() {
		return lastModifylUser;
	}


	public void setLastModifylUser(Integer lastModifylUser) {
		this.lastModifylUser = lastModifylUser;
	}
